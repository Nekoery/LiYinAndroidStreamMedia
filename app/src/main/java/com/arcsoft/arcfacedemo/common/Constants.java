...
public class Constants {
    ...
    public static final String APP_ID = "83vDCFz5fUFdKy9b4YaEXC5cKcQbF2Ciu6QZgGRj8eXn";
    public static final String SDK_KEY = "2cUMF9efFBJrPmTpNFnhcaWjyrTsS2TbcvsZhJewdu7M";
